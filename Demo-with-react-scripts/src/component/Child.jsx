...
class Child extends React.Component {
  render() {
    ...
    if (this.props.childData != null) {
      mydata = this.props.childData.data && this.props.childData.data.slice(0, 2).map((data) => {        
          ...
          <ul key={data.id}>
            ...
            <li className="flex"><strong>User Address:</strong>
              <ul>
                <li style={{ display: 'flex' }}>
                  <strong style={{ width: '80px' }}>Street:</strong>
                  {data.address ? data.address.street : ''}
                </li>
                <li style={{ display: 'flex' }}>
                  <strong style={{ width: '80px' }}>Suite:</strong>
                  {data.address ? data.address.suite : ''}
                </li>
                <li style={{ display: 'flex' }}>
                  <strong style={{ width: '80px' }}>Zipcode:</strong>
                  {data.address ? data.address.zipcode : ''}
                </li>
                <li style={{ display: 'flex' }}>
                  <strong style={{ width: '80px' }}>City:</strong>
            ...
            <li className="flex"><strong>User Company:</strong>
              <ul>
                ...
                <li style={{ display: 'flex' }}>
                  <strong style={{ width: '120px' }}>CatchPhrase:</strong>
                  {data.company ? data.company.catchPhrase : ''}</li>
                <li style={{ display: 'flex' }}><strong style={{ width: '120px' }}>Bs:</strong> {data.company ? data.company.bs : ''}</li>
              </ul>
            </li>
